...
public class JsonBenchmark {
	...
	public static class MyState {
		...
		// JSON to POJO mapper with afterburner module
		ObjectMapper jsonObjectMapperAfterburner = (new ObjectMapper()).registerModule(new AfterburnerModule());
	}

	@Benchmark
	public NotificationEvent jsoniterTestString(MyState state) {
		// place your benchmarked code here
		return JsonIterator.deserialize(state.message, NotificationEvent.class);
	}

	@Benchmark
	public NotificationEvent jacksonTestString(MyState state) throws IOException {
		// place your benchmarked code here
		return state.jsonObjectMapper.readValue(state.message, NotificationEvent.class);
	}

	@Benchmark
	public NotificationEvent jsoniterTestBytes(MyState state) {
		// place your benchmarked code here
		return JsonIterator.deserialize(state.message.getBytes(), NotificationEvent.class);
	}

	@Benchmark
	public NotificationEvent jacksonTestBytes(MyState state) throws IOException {
		// place your benchmarked code here
		return state.jsonObjectMapper.readValue(state.message.getBytes(), NotificationEvent.class);
	}

	@Benchmark
	public NotificationEvent jacksonTestString_Afterburner(MyState state) throws IOException {
		// place your benchmarked code here
		return state.jsonObjectMapperAfterburner.readValue(state.message, NotificationEvent.class);
	}

	@Benchmark
	public NotificationEvent jacksonTestBytes_Afterburner(MyState state) throws IOException {
		// place your benchmarked code here
		return state.jsonObjectMapperAfterburner.readValue(state.message.getBytes(), NotificationEvent.class);
	}
}
